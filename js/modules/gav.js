...
function initGavPanel() {
    ...
    const CASES = [
        {id:'E1', cible:'Famille', titre:'Enfant – brûlure eau bouillante', emoji:'🔥', resume:'Brûlures 2e degré, greffe, cicatrices.', sans: 500, avec: 42440, tags:['Hôpital', 'Cicatrices']},
        {id:'P1', cible:'Adulte', titre:'Parent – chute d’échelle', emoji:'🪜', resume:'Fracture lombaire, séquelles dos, arrêt 6 mois.', sans: 4000, avec: 84600, tags:['Arrêt pro', 'Rééduc']},
        {id:'A1', cible:'Ado', titre:'Ado – rupture LCA (sport)', emoji:'🤾', resume:'Chirurgie + rééduc; année scolaire perturbée.', sans: 1000, avec: 33640, tags:['Chirurgie', 'Perte année scolaire']},
        ...
        {id:'E2', cible:'Famille', titre:'Enfant – fracture du bras', emoji:'🦴', resume:'Fracture opérée, broches, rééducation.', sans: 200, avec: 150, tags:['Plâtre', 'Chirurgie', 'IP<5%']},
        {id:'E3', cible:'Famille', titre:'Enfant – dent cassée (vélo)', emoji:'🦷', resume:'Chute sur le visage; incisive définitive cassée.', sans: 300, avec: 0, tags:['Prothèse dentaire', 'IP<5%']},
        ...
        {id:'A5', cible:'Ado', titre:'Ado – chute VTT (clavicule)', emoji:'🚲', resume:'Fracture de la clavicule; petite cicatrice.', sans: 200, avec: 22500, tags:['Cicatrice', 'Rééduc']},
        ...
        {id:'S3', cible:'Senior', titre:'70 ans – fracture poignet', emoji:'💪', resume:'Plaque + rééduc; faiblesse permanente.', sans: 200, avec: 25280, tags:['Ostéosynthèse', 'Rééduc']},
